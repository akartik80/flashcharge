...
<body onload="document.getElementById('welcome').innerHTML = '<?php echo "Welcome ".strtoupper($_GET['id']) ?>'">
  ...
  <div class='container-fluid'>
    ...
    <div class='container2 col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main'>
        <h1 class='page-header' align='center'>Principles of Programming Languages</h1>
        
        <div class='container body-text2 form-group'>
            <h2>Feedback for theory classes</h2>
                <br>
                <p><b>1.</b> The lecturer(s) communicated the learning outcomes of dbms to me:</p>
        ...
        <div align='center'>
            <button type='button' class='btn btn-primary' id='allfeedback'>View all feedbacks</button>
        </div>
        <br><br><br><br><br><br>";
        ?>
</body>
