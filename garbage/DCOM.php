...
<body onload="document.getElementById('welcome').innerHTML = '<?php echo "Welcome ".$_GET['Roll_No'] ?>'">
            ...
            <div class='row'>
                <div class='col-sm-3 col-md-2 sidebar side'>
                    ...
                    <ul class='nav nav-sidebar'>
                        ...
                        <li class='active' id='sub5'><a href='".$arr[4].".php?Roll_No=".$id."'>$arr[4]</a></li>
                    </ul>";
    ...
    if (isset ($_POST['submit'])) {
        ...
        $q  = "insert into dcom values ('$id', '$q1', '$q2', '$q3', '$q4', '$q5', '$q6', '$q7', '$q8', '$q9', '$q10', '$q11', '$q12', '$q13')";
        $result = mysql_query ($q);
        header("Location: thankyou.php?c_id=DCOM&Roll_No=$id");
    }
