...
<body onload="document.getElementById('welcome').innerHTML = '<?php echo "Welcome ".$_GET['Roll_No'] ?>'">
            ...
            <div class='row'>
                <div class='col-sm-3 col-md-2 sidebar side'>
                    ...
                    <ul class='nav nav-sidebar'>
                        ...
                        <li class='active' id='sub1'><a href='".$arr[0].".php?Roll_No=".$id."'>$arr[0]</a></li>
    ...
    if (isset ($_POST['submit'])) {
        ...
        $q  = "insert into daa values ('$id', '$q1', '$q2', '$q3', '$q4', '$q5', '$q6', '$q7', '$q8', '$q9', '$q10', '$q11', '$q12', '$q13')";
        $result = mysql_query ($q);
  ...
  <div class='container-fluid'>
    <div class='navbar-header'>
      <a class='navbar-brand' href='index.html'>Online Feedback System</a>
    </div>
    <div>
    ...
    if ($submitted == 0) {
        echo "<div class='container2 col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main'>
            ...
            $q = "select q1 from daa where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a1 = $row[0];

            $q = "select q2 from daa where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a2 = $row[0];

            $q = "select q3 from daa where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a3 = $row[0];

            $q = "select q4 from daa where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a4 = $row[0];

            $q = "select q5 from daa where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a5 = $row[0];

            $q = "select q6 from daa where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a6 = $row[0];

            $q = "select q7 from daa where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a7 = $row[0];

            $q = "select q8 from daa where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a8 = $row[0];

            $q = "select q9 from daa where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a9 = $row[0];

            $q = "select q10 from daa where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a10 = $row[0];

            $q = "select q11 from daa where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a11 = $row[0];

            $q = "select q12 from daa where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a12 = $row[0];
            ...
            <div class='container body-text2 form-group'>
                ...
                <form name='feedback' action='' method='post' id='feedback' onsubmit= 'return validateForm()'>
                    <br>
                    <p><b><font color='red'>*</font> 1.</b> The lecturer(s) communicated the learning outcomes of DAA to me:</p>
                
                    <div class='radio'>
                        <label><input type='radio' name='q1' value = '1'"; if($a1 == 1) {echo "checked = 'checked'";} echo" disabled>Unclearly</label>
                    </div>

                    <div class='radio'>
                        <label><input type='radio' name='q1' value = '2'"; if($a1 == 2) {echo "checked = 'checked'";} echo" disabled>Clearly</label>
                    </div>
        
                    <div class='radio'>
                        <label><input type='radio' name='q1' value = '3'"; if($a1 == 3) {echo "checked = 'checked'";} echo" disabled>Very clearly</label>
                    </div>
                    ...
                    <div class='radio'>
                        <label><input type='radio' name='q2' value = '1'"; if($a2 == 1) {echo "checked = 'checked'";} echo" disabled>Strongly disagree</label>
                    </div>
                       
                    <div class='radio'>
                        <label><input type='radio' name='q2' value = '2'"; if($a2 == 2) {echo "checked = 'checked'";} echo" disabled>Disagree</label>
                    </div>

                    <div class='radio'>
                        <label><input type='radio' name='q2' value = '3'"; if($a2 == 3) {echo "checked = 'checked'";} echo" disabled>Agree</label>
                    </div>
        
                    <div class='radio'>
                        <label><input type='radio' name='q2' value = '4'"; if($a2 == 4) {echo "checked = 'checked'";} echo" disabled>Strongly agree</label>
                    </div>
                    ...
                    <div class='radio'>
                        <label><input type='radio' name='q3' value = '1'"; if($a3 == 1) {echo "checked = 'checked'";} echo" disabled>Not at all</label>
                    </div>
                    
                    <div class='radio'>
                        <label><input type='radio' name='q3' value = '2'"; if($a3 == 2) {echo "checked = 'checked'";} echo" disabled>Partially</label>
                    </div>

                    <div class='radio'>
                        <label><input type='radio' name='q3' value = '3'"; if($a3 == 3) {echo "checked = 'checked'";} echo" disabled>Fully</label>
                    </div>
                    ...
                    <div class='radio'>
                        <label><input type='radio' name='q4' value = '1'"; if($a4 == 1) {echo "checked = 'checked'";} echo" disabled>Much heavier</label>
                    </div>


                    <div class='radio'>
                        <label><input type='radio' name='q4' value = '2'"; if($a4 == 2) {echo "checked = 'checked'";} echo" disabled>Heavier</label>
                    </div>
                    
                    <div class='radio'>
                        <label><input type='radio' name='q4' value = '3'"; if($a4 == 3) {echo "checked = 'checked'";} echo" disabled>Lighter</label>
                    </div>
        
                    <div class='radio'>
                        <label><input type='radio' name='q4' value = '4'"; if($a4 == 4) {echo "checked = 'checked'";} echo" disabled>Much lighter</label>
                    </div>
                    ...
                    <div class='radio'>
                        <label><input type='radio' name='q5' value='1'"; if($a5 == 1) {echo "checked = 'checked'";} echo" disabled>Very hard</label>
                    </div>
        
                    <div class='radio'>
                        <label><input type='radio' name='q5' value='2'"; if($a5 == 2) {echo "checked = 'checked'";} echo" disabled>Hard</label>
                    </div>

                    <div class='radio'>
                        <label><input type='radio' name='q5' value='3'"; if($a5 == 3) {echo "checked = 'checked'";} echo" disabled>Easy</label>
                    </div>
                    
                    <div class='radio'>
                        <label><input type='radio' name='q5' value='4'"; if($a5 == 4) {echo "checked = 'checked'";} echo" disabled>Very easy</label>
                    </div>
                    ...
                    <br>
                    <span class = 'stars'>
                        <input class='star star-5' id='star-51' type='radio' name='q6' value='5'"; if($a6 == 1) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-5' for='star-51'></label>
                        <input class='star star-4' id='star-41' type='radio' name='q6' value='4'"; if($a6 == 2) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-4' for='star-41'></label>
                        <input class='star star-3' id='star-31' type='radio' name='q6' value='3'"; if($a6 == 3) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-3' for='star-31'></label>
                        <input class='star star-2' id='star-21' type='radio' name='q6' value='2'"; if($a6 == 4) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-2' for='star-21'></label>
                        <input class='star star-1' id='star-11' type='radio' name='q6' value='1'"; if($a6 == 5) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-1' for='star-11'></label>
                    </span>
                    <br><br><br><br>
                    <span>
                    ...
                    <br>    
                    <span class = 'stars'>
                        <input class='star star-5' id='star-52' type='radio' name='q7' value='5'"; if($a7 == 1) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-5' for='star-52'></label>
                        <input class='star star-4' id='star-42' type='radio' name='q7' value='4'"; if($a7 == 2) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-4' for='star-42'></label>
                        <input class='star star-3' id='star-32' type='radio' name='q7' value='3'"; if($a7 == 3) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-3' for='star-32'></label>
                        <input class='star star-2' id='star-22' type='radio' name='q7' value='2'"; if($a7 == 4) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-2' for='star-22'></label>
                        <input class='star star-1' id='star-12' type='radio' name='q7' value='1'"; if($a7 == 5) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-1' for='star-12'></label>
                    </span>
                    <br><br><br><br>
                    <span>
                    ...
                    <br>    
                    <span class = 'stars'>
                        <input class='star star-5' id='star-53' type='radio' name='q8' value='5'"; if($a8 == 1) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-5' for='star-53'></label>
                        <input class='star star-4' id='star-43' type='radio' name='q8' value='4'"; if($a8 == 2) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-4' for='star-43'></label>
                        <input class='star star-3' id='star-33' type='radio' name='q8' value='3'"; if($a8 == 3) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-3' for='star-33'></label>
                        <input class='star star-2' id='star-23' type='radio' name='q8' value='2'"; if($a8 == 4) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-2' for='star-23'></label>
                        <input class='star star-1' id='star-13' type='radio' name='q8' value='1'"; if($a8 == 5) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-1' for='star-13'></label>
                    </span>
                    <br><br><br><br>
                    <span>
                    ...
                    <br>    
                    <span class = 'stars'>
                        <input class='star star-5' id='star-54' type='radio' name='q9' value='5'"; if($a9 == 1) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-5' for='star-54'></label>
                        <input class='star star-4' id='star-44' type='radio' name='q9' value='4'"; if($a9 == 2) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-4' for='star-44'></label>
                        <input class='star star-3' id='star-34' type='radio' name='q9' value='3'"; if($a9 == 3) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-3' for='star-34'></label>
                        <input class='star star-2' id='star-24' type='radio' name='q9' value='2'"; if($a9 == 4) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-2' for='star-24'></label>
                        <input class='star star-1' id='star-14' type='radio' name='q9' value='1'"; if($a9 == 5) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-1' for='star-14'></label>
                    </span>
                    <br><br><br><br>
                    <span>
                    ...
                    <br>    
                    <span class = 'stars'>
                        <input class='star star-5' id='star-55' type='radio' name='q10' value='5'"; if($a10 == 4) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-5' for='star-55'></label>
                        <input class='star star-4' id='star-45' type='radio' name='q10' value='4'"; if($a10 == 4) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-4' for='star-45'></label>
                        <input class='star star-3' id='star-35' type='radio' name='q10' value='3'"; if($a10 == 4) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-3' for='star-35'></label>
                        <input class='star star-2' id='star-25' type='radio' name='q10' value='2'"; if($a10 == 4) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-2' for='star-25'></label>
                        <input class='star star-1' id='star-15' type='radio' name='q10' value='1'"; if($a10 == 4) {echo "checked = 'checked'";} echo" disabled/>
                        <label class='star star-1' for='star-15'></label>
                    </span>
                    <br><br><br><br>
                    ...
                    <label for='comment'>Comment:</label>
                    <textarea class='form-control width' rows='5' id='comment' name='q11' form='feedback' placeholder='200 characters max' maxlength='200' disabled='true'>"; echo $a11; echo "</textarea>
                    <br><br>
                    ...
                    <label for='comment'>Comment:</label>
                    <textarea class='form-control width' rows='5' id='comment' name='q12' placeholder='200 characters max' maxlength='200' form='feedback' disabled='true'>"; echo $a12; echo "</textarea>
                    <br><br>
                    ...
                    You have already submitted feedback for DAA, the selected values show your feedback.
                    <br><br><br><br>
                </form>
            </div>";
        }
