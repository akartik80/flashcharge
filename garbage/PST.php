...
<body onload="document.getElementById('welcome').innerHTML = '<?php echo "Welcome ".$_GET['Roll_No'] ?>'">
            ...
            <div class='row'>
                <div class='col-sm-3 col-md-2 sidebar side'>
                    ...
                    <ul class='nav nav-sidebar'>
                        ...
                        <li class='active' id='sub4'><a href='".$arr[3].".php?Roll_No=".$id."'>$arr[3]</a></li>
    ...
    if (isset ($_POST['submit'])) {
        ...
        $q  = "insert into pst values ('$id', '$q1', '$q2', '$q3', '$q4', '$q5', '$q6', '$q7', '$q8', '$q9', '$q10', '$q11', '$q12', '$q13')";
        $result = mysql_query ($q);
        header("Location: thankyou.php?c_id=PST&Roll_No=$id");
    }
  ...
  <div class='container-fluid'>
    ...
    if ($submitted == 0) {
        echo "<div class='container2 col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main'>
            ...
            $q = "select q1 from pst where Student_id = '$id'";
            $result = mysql_query ($q);
            $row = mysql_fetch_array($result);
            $a1 = $row[0];
